...
figure, image(HW1NibMin), axis off, colormap gray(2)
figure, image(HW4NibMin), axis off, colormap gray(2)
figure, image(PR4NibMin), axis off, colormap gray(2)
figure, image(PR7NibMin), axis off, colormap gray(2)

%Displayed Images that have been binarized using Niblack's method (with a
%small neighbourhood size).
figure, image(HW1NibMax), axis off, colormap gray(2)
figure, image(HW4NibMax), axis off, colormap gray(2)
figure, image(PR4NibMax), axis off, colormap gray(2)
figure, image(PR7NibMax), axis off, colormap gray(2)